...
int numComparisonsQuick = 0;
int numMemAccessesQuick = 0;
...
int Partition(std::vector<int>* numbers, int i, int k) {
   ...
   numMemAccessesQuick ++; // read pivot once
   ...
   while (!done) {
      ...
      while ((*numbers)[l] < pivot) {
         numComparisonsQuick++;    // comparison
         numMemAccessesQuick ++; // two reads
         ++l;
      }
